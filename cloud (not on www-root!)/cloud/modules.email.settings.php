...
window.myCloudShowEmailSettings = function() {
    ...
    if (canEditSettings) {
        ...
        if ('registerProtocolHandler' in navigator) {
            mailtoBtn = '<button class="owa-btn" style="margin-inline-end:auto;" title="' + (L.set_default_mail || 'Set as Default Mail App') + '" onclick="navigator.registerProtocolHandler(\'mailto\', window.location.origin + window.location.pathname + \'?mailto=%s\', \'MyDocpile Webmail\');">' + 
                ...
                '<span class="hide-mobile">' + (L.set_default_mail || 'Set as Default Mail App') + '</span>' +
            '</button>';
        }

        listHtml += 
            '<div style="display:flex; justify-content:flex-end; align-items:center; padding-top:15px; border-top:1px solid var(--border-default); margin-top:10px;">' +
                mailtoBtn +
